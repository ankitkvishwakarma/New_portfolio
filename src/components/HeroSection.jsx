  ...
  return (
    ...
    >
      <motion.div
        ...
        className="relative z-10 w-[95%] max-w-[1280px] mx-auto"
      >
        <div
          className={`
            w-full
            ...
            ${
              darkMode
                ? "bg-white/[0.03] border border-cyan-500/20 shadow-[0_0_80px_rgba(0,255,255,0.08)]"
          ...
          >
            ...
            <div className="flex flex-col items-center lg:items-start">
              <div className="relative group">
                ...
                <div className="absolute bottom-4 right-4 px-4 py-2 rounded-full bg-black/70 backdrop-blur-md border border-cyan-400/20 flex items-center gap-2 text-white">
            ...
            >
              ...
              {/* Description */}
              <p
                className={`text-base md:text-lg mt-8 leading-8 max-w-xl mx-auto lg:mx-0 ${
